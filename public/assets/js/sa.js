!(function(t, e) {
  ...
  function et(t) {
    ue.isVisible() && ot !== t.target.value && ue.resetValidationMessage(),
      (ot = t.target.value);
  }
  function nt(t, e) {
  ...
  var ot,
    ...
    ut = '\n <div aria-labelledby="'
      ...
      .concat(B.close, '">&times;</button>\n   </div>\n   <div class="')
      .concat(B.content, '">\n     <div id="')
      .concat(B.content, '"></div>\n     <input class="')
      ...
      .concat(B.actions, '">\n     <button type="button" class="')
      .concat(B.confirm, '">OK</button>\n     <button type="button" class="')
      .concat(B.cancel, '">Cancel</button>\n   </div>\n   <div class="')
      .concat(B.footer, '">\n   </div>\n </div>\n')
      .replace(/(^|\n)\s*/g, ""),
    ct = function(t) {
      if (
        ...
        n.appendChild(e),
          ...
          (function(t) {
            "rtl" === window.getComputedStyle(t).direction && it(H(), B.rtl);
          })(n),
          (function() {
            var t = _(),
              e = at(t, B.input),
  ...
  function pt(t, e, n) {
    M(t, n["showC" + e.substring(1) + "Button"], "inline-block"),
      ...
      it(t, n[e + "ButtonClass"]);
  }
  function ft(t, e) {
    var n = Q(),
      o = K(),
      i = Z();
    e.showConfirmButton || e.showCancelButton ? L(n) : O(n),
  ...
  function mt(t, e) {
    ...
    n &&
      ...
      e.customContainerClass && it(n, e.customContainerClass));
  }
  function gt(t, e) {
  ...
  var ht = {
    ...
    wt = function(t, e, n) {
      (t.className = e),
        n.inputClass && it(t, n.inputClass),
        n.customClass && it(t, n.customClass.input);
    },
    Ct = {};
  ...
  function Bt(t, i) {
    ...
    L(r), (r.innerHTML = "");
    var a = parseInt(
      null === i.currentProgressStep ? ue.getQueueStep() : i.currentProgressStep
    );
    a >= i.progressSteps.length &&
      ...
      i.progressSteps.forEach(function(t, e) {
        ...
        if (
          (r.appendChild(n),
          e === a && it(n, B["active-progress-step"]),
    ...
    y(n, e.customClass, "header"),
      ...
      (function(t, e) {
        ...
        L(n),
          ...
          e.imageClass && it(n, e.imageClass);
      })(0, e),
      (function(t, e) {
        var n = U();
  ...
  function St(t, e) {
    !(function(t, e) {
      ...
      T(n, "width", e.width),
        ...
        "string" == typeof e.customClass && it(n, e.customClass),
        E(n, B.noanimation, !e.animation);
    })(0, e),
      mt(0, e),
      xt(t, e),
      kt(t, e),
  ...
  function Kt(t) {
    ...
    if (e && !b(e, B.hide)) {
      var n = ht.innerParams.get(this),
        o = Ft.swalPromiseResolve.get(this),
        i = n.onClose,
        r = n.onAfterClose;
      rt(e, B.show),
        it(e, B.hide),
        ...
        o(t || {}),
        (Vt.deferDisposalTimer = setTimeout(
          function() {
            delete this.params,
              delete Vt.keydownHandler,
              delete Vt.keydownTarget,
              Qt(ht),
              Qt(Ft);
          }.bind(this),
          36e3
  ...
  var Zt = function(e, t, n) {
      (Vt.swalClosing = !0),
        (Vt.swalCloseEventFinishedCallback = Wt.bind(null, t, st(), n)),
        e.addEventListener(dt, function(t) {
          t.target === e &&
            Vt.swalClosing &&
            (delete Vt.swalClosing,
            Vt.swalCloseEventFinishedCallback(),
            delete Vt.swalCloseEventFinishedCallback);
        });
    },
    Qt = function(t) {
  ...
  function ne(t) {
    ...
    null !== t.onBeforeOpen &&
      ...
      t.onBeforeOpen(n),
      t.animation && (it(n, B.show), it(e, B.fade)),
      L(n),
      dt && j(n)
        ? ((e.style.overflowY = "hidden"),
          n.addEventListener(dt, ee.bind(null, n, e)))
        : (e.style.overflowY = "auto"),
      it([document.documentElement, document.body, e], B.shown),
      t.heightAuto &&
        t.backdrop &&
        !t.toast &&
        it([document.documentElement, document.body], B["height-auto"]),
      G() &&
        (t.scrollbarPadding && Nt(),
        (function() {
          if (
            /iPad|iPhone|iPod/.test(navigator.userAgent) &&
            !window.MSStream &&
            !b(document.body, B.iosfix)
          ) {
  ...
  var re,
    ae = Object.freeze({
      ...
      _main: function(t) {
        ...
        !(function(t) {
          for (var e in t)
            Lt((i = e)) || w('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e),
                -1 !== It.indexOf(o) &&
                  w(
          ...
          Vt.swalClosing &&
            ...
            Vt.swalCloseEventFinishedCallback(),
            delete Vt.swalCloseEventFinishedCallback),
          Vt.deferDisposalTimer &&
            (clearTimeout(Vt.deferDisposalTimer), delete Vt.deferDisposalTimer);
        var l = a({}, jt, t);
        te(l),
          Object.freeze(l),
        ...
        return new Promise(function(t) {
          ...
          Vt.keydownTarget &&
            ...
            l.toast ||
              ...
              (Vt.keydownTarget = l.keydownListenerCapture ? window : d.popup),
              (Vt.keydownListenerCapture = l.keydownListenerCapture),
            ...
            l.toast && (l.input || l.footer || l.showCloseButton)
              ...
              : rt(document.body, B["toast-column"]),
            "select" === l.input || "radio" === l.input
              ? (function(e, n) {
                  function o(t) {
                    return oe[n.input](i, ie(t), n);
                  }
                  var i = _();
                  v(n.inputOptions)
                    ? (Et(),
